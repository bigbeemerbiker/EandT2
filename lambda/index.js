...
const ShowVideoIntentHandler = {
  ...
  handle(handlerInput) {
    ...
    //handlerInput.requestEnvelope.request.intent.slots.SLOTNAME.value;   // this one might not find exact slot value
    ...
    let videoClip = null;
    let chat = null;
    if(typeof topic_chosen === 'undefined') video = 'any'; else video = topic_chosen.name;
